...
### What I focus on
- Strong constraints as a forcing function for better engineering  
- Tooling that cuts overhead rather than adding ceremony  
- Clear interfaces and small, understandable systems  
- Practical, throughput-focused uses of AI  

### Still hands-on
- [Dotfiles](https://github.com/lanej/dotfiles)  
- Proud sponsor of the [Neovim](https://neovim.io) project  
